<template>
  <view class="container pb115 ">
    ...
    <mg-input v-model="params.userTel" ht="手机号" hw="130" :max="11" pr="请输入手机号" t="number" :value="params.userTel" vueId="2fb9fb3f-4"></mg-input>
    <mg-input arrow="1" @tab="chooseLocation" dis="1" ht="地址" hw="130" pr="请选择地址" :value="params.address" vueId="2fb9fb3f-5"></mg-input>
    ...
    <mg-cell ht="标签" hw="130" last="1" vueId="2fb9fb3f-7" :vueSlots="['bd']">
      <view class="f-raw " slot="bd">
        <bk-b @tab="label(v)" :cName="'be6 mr30 '+(params.label!=v&&'c3')" :color="params.label==v?tColor:''" :t="v" :vueId="'2fb9fb3f-8-'+i+','+'2fb9fb3f-7'" v-for="(v, i) in labels" :key="i"></bk-b>
      </view>
    </mg-cell>
    ...
    <view class="foot-btnc ">
      <button @tap="save" class="foot-btn " :disabled="loading" :loading="loading" :style="'background:'+tColor+';'">保存</button>
    </view>
