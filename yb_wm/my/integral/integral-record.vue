<template>
  <view>
    <navBar :title="'购买记录'" :backgroundColor="'linear-gradient(227deg, #FAC763 0%, #F9BD40 100%)'" :wordColor="'#fff'"></navBar>
    <view class="pt110 pb130 ">
      <nav-tab @changeTab="changeTab" cname="" v-model="aIdx" :tabs="tabs" vueId="a398d456-1"></nav-tab>
...
export default {
  ...
  onLoad: function (t) {
    this.getSystem(), setNT("购买记录"), this.aIdx = +t.idx || 0, this.changeTab(this.aIdx)
  },
  mixins: [sljz],
  computed: {
    jfName: function () {
