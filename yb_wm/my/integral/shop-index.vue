  ...
  <view class="bf ">
    ...
    <block v-if="hotList.length">
      ...
      <view class="bf f-row o-x-s p23 ">
        <view @tap="go({t:1,url:'/yb_wm/my/integral/details?id='+v.id})" class="bf f-g-0 goodsc mr30 bs15 b-s-1 " v-for="(v, i) in hotList" :key="i">
          <view class="goodsimg ">
    ...
    <!-- <view class="footer">
      <view class="itemicon" @tap="tabchang(0)">
        <image src="../../../static/imgs/barindexnoselect.png" mode="aspectFit"></image>
      </view>
      <view class="itemicon" @tap="tabchang(1)">
        <image src="../../../static/imgs/barshopselect.png" mode="aspectFit"></image>
      </view>
