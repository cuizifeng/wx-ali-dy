  ...
  <view class="container pb115 ">
    ...
    <view class="foot-btnc posi-r ">
      ...
      <view class="receive_vip">
        ...
        <button class="btn1" hover-class="none" @click="later">稍后领取</button>
        <!-- </navigator> -->
...
export default {
  ...
  onLoad: function (e) {
    var n = this;
    console.log(n.user);
    this.params.birthday = this.getCurrentDate()
    setNT("个人信息"),
      n.getSystem(),
      ...
      n.getLoginInfo().then(function (res) {
        ...
        n.params.userId = uni.getStorageSync('userId'),
  ...
  methods: {
    ...
    save() {
      ...
      this.$api.login_save__user(e.params).then(res => {
        if (res.code == 1) {
          Tips({ title: '保存成功', type: 4, url: '/pages/tabbar/my/index', end: 3000 })
        } else {
          Tips({ title: res.msg, })
        }
        // console.log(res, "7")
