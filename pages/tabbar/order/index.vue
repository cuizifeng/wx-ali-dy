...
export default {
  ...
  computed: {
    ...
    ModeArr: function () {
      ...
      return this.sjxx.moreSet && (2 == this.sjxx.moreSet.distributionSupport.length ? (t = [{
        ...
        value: "1"
      }], 2 == this.sjxx.moreSet.auto && t.reverse(), this.xdtype && (this.buyType = this
        .xdtype))
  ...
  methods: {
    ...
    changeStore: function (t) {
      //   this.showloading = !0,
      this.tcyhqshow = this.tcggshow = this.jsgdwb = !1, this.startMoney = "",
        ...
        e.getSjxx({
          ...
          e.getMycar({
            ...
            e.storeId = e.sjxx.shopData.id, e.goodsList = deepCopy(e.sjxx.recommendData),
              e.catrgoryList = deepCopy(e.sjxx.data),
              e.showloading = !1;
            e.getConfig({
              key: "storeInfo",
              data: {
  ...
  onShow: function () {
    this.sjxx.moreSet && (this.storeId != this.storeInfo.id ? this.changeStore(this.storeInfo) : (this.ModeArr.length &&
      2 == this.ModeArr[0].value && (1 != this.buyType && getApp().globalData.xzdzInfo ?
        this.buyType = 1 : 1 != this.buyType || getApp().globalData.xzdzInfo || (this.buyType = 2)),
      this.refreshList()));
  },
