<template>
  <view class="bf f-raw f-bt p23 " v-if="goodsList.length">
    <view @tap="go({t:1,url:'/yb_wm/my/integral/details?id='+v.id+'&qrcodeId='+qrcodeId})" class="bf goodsc mb20 bs15 b-s-1 " v-for="(v, i) in goodsList" :key="i">
      <view class="goodsimg ">
        <mg-img class="" :src="v.icon" :vueId="'7e1ced00-1-'+i"></mg-img>
      </view>
      <view class="jfgb ">
        <view class="f-bt ">
          <view class="bf2 cf f24 mr10 boxs f-g-0 " v-if="v.type=='2'">红</view>
