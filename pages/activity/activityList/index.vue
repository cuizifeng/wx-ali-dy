  ...
  data() {
    return {
      comList: [{
        ...
        img: 'https://img1.baidu.com/it/u=2656997690,163773951&fm=253&fmt=auto&app=120&f=JPEG?w=889&h=500',
      ...
      },
      {
        ...
        img: 'https://img1.baidu.com/it/u=3883901410,74560379&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=667',
        name: '具体样式您可以自定义',
        commdityPrice: 100
      }, {
        img: 'https://img0.baidu.com/it/u=2862534777,914942650&fm=253&fmt=auto&app=138&f=JPEG?w=889&h=500',
        name: 'vue的H5页面也是如此使用',
        commdityPrice: 100
      },
      {
